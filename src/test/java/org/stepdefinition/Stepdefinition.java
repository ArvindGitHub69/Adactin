...
public class Stepdefinition extends BaseClass {
	...
	public void user_gives_the_valid_user_name_and_password() {
		enterText(POM.getHomePage().getUsername(), "SuguAravind");
		enterText(POM.getHomePage().getPassword(), "sugu@3005");
	}
	...
	public void user_will_select_the_check_in_date() throws AWTException {
		POM.getSearchHotelPage().getDatepick_in("01/01/2022");
	...
	public void user_will_select_the_check_out_date() {
		try {
			POM.getSearchHotelPage().getDatepick_out("05/01/2022");
